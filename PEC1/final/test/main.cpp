...
int main(int argc, char** argv)
{
	...
	do {
		...
		case 'K':
			...
			break;
		case 'L':
			gestor.mostrarSociosArbol();
			break;
		case 'M':
			gestor.mostrarSimpatizantesArbol();
			break;
		case 'N':
			gestor.mostrarTodosArbolInorden();
			break;
		case 'O':
			gestor.buscarAficionadosArbol();
			break;
		case 'P':
			gestor.contarAficionadosConIdentificadorPar();
			break;
		case 'Q':
			gestor.mostrarAficionadosEnNodoHoja();
			break;
		case 'R':
			gestor.eliminarAficionado();
			break;
		case 'S':
